...
namespace BluePrintEditor.Designer.Controls
{
    public class DesignerCanvas : Canvas
    {
        ...
        public IEnumerable<CanvasBaseItem> SelectedItems
        {
            get
            {
                var selectedItems = from item in this.Children.OfType<CanvasBaseItem>()
        ...
        {
            foreach (CanvasBaseItem item in this.SelectedItems)
            {
